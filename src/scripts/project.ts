...
export const project = [
  ...
  },
  {
    ...
    content: {
      tech: ["C/C++", "TypeScript","JavaScript", "Vue.JS", "Node.JS"],
      todo: [
        "1.根据产品需求,开发嵌入式仪表的Web部分功能, 包含Web前端和Web Server的开发",
        "2.根据Global UI 团队需求, 改进Web端前端样式",
        "3.根据项目需求, 设计和定义Web端数据通讯接口和协议内容",
        "4.参与Web端整体架构迁移和性能改进工作",
      ],
      done: [
        "1.成功开发了IND590项目的Web端功能, 包含Web前端和Web Server的开发工作, 满足了项目需求",
        "2.成功改进了Web端前端样式, 满足了Global UI 团队的需求",
        "3.成功设计和定义了Web端数据通讯接口和协议内容, 满足了项目需求",
        "4.成功参与了Web端整体架构迁移和性能改进工作, 提升了Web端的性能和稳定性",
        "5.成功推动了IND590项目的Web端开发工作, 确保了项目的顺利进行",
        "6.独立开发Web Server层的用户&心跳管理模块, 并深度结合JWT技术实现了仪表用户和Web端用户的统一认证和管理",
      ],
    },
  },
  {
